        ...
        <figure className="investigation-doodle" aria-labelledby="case-flow-title">
          ...
          <ol className="investigation-doodle__stages">
            {investigationStages.map((stage, index) => (
              <li className={`investigation-doodle__stage investigation-doodle__stage--${index + 1} scroll-reveal`} key={stage.id}>
          ...
          <div className="investigation-doodle__workers" aria-label="Specialized analysis workers">
