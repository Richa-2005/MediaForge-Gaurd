...
export function AboutPage() {
  return <div className="site-shell case-study-page"><a className="skip-link" href="#main-content">Skip to content</a><SiteHeader /><main id="main-content">
    ...
    <section className="case-mission section"><div className="container"><div className="case-mission__lead scroll-reveal"><p className="eyebrow">Our vision &amp; mission</p><h2>Trustworthy assistance begins with a readable process.</h2></div><div className="case-mission__columns"><article className="scroll-reveal"><span>Vision</span><h3>Support trustworthy, AI-assisted media verification through evidence-aware investigation workflows.</h3><p>Long-term, the project aims to make complex media analysis easier to inspect and understand - without presenting automated output as a substitute for human judgment.</p></article><article className="scroll-reveal"><span>Mission</span><h3>Deliver a working system that accepts media, routes it to relevant implemented analysis paths, stores the results, and produces a structured report when available.</h3><p>Today, the product focuses on making its existing processing path legible from upload through review.</p></article></div></div></section>
